...
import { GameDisplayComponent as OnlineTournamentGameDisplayComponent } from './games/tournament/online/game-display/game-display.component';
...
@NgModule({
  declarations: [
    ...
    OnlineTournamentGameDisplayComponent,
