...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(seconds=1),  # Keep your original access token lifetime
    'REFRESH_TOKEN_LIFETIME': timedelta(hours=7),  # Keep your original refresh token lifetime
