    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_rounds', models.IntegerField(default=3, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(25)])),
                ('round_score_limit', models.IntegerField(default=3, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(25)])),
            ],
        ),
        migrations.CreateModel(
            name='Match',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player3_name_pvp_local', models.CharField(blank=True, max_length=100, null=True)),
                ('player4_name_pvp_local', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('lobby', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='games', to='games.baselobby')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_host_ready', models.BooleanField(default=False)),
                ('is_guest_ready', models.BooleanField(default=False)),
                ('powerup_spawn_rate', models.FloatField(default=10)),
                ('host_paddle_color', models.CharField(default='#FFFFFF', max_length=7)),
                ('guest_paddle_color', models.CharField(default='#FFFFFF', max_length=7)),
                ('host_paddle_image', models.ImageField(blank=True, null=True, upload_to='paddle_skins/')),
                ('guest_paddle_image', models.ImageField(blank=True, null=True, upload_to='paddle_skins/')),
