...
@Component({
  selector: 'app-game-room-chaos',
  templateUrl: './game-room-chaos.component.html',
  styleUrls: ['./game-room-chaos.component.scss']
})
export class GameRoomChaosComponent implements OnInit, OnDestroy {
  roomId: string = '';
  host: string = '';
  ...
  constructor(
    ...
    private lobbyService: GameLobbyChaosService,
